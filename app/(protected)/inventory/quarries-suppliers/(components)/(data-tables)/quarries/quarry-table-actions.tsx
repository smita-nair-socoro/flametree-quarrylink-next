...
export function QuarryTableAction({ quarry }: QuarryTableActionProps) {
  // TODO: Create quarry-specific hooks and modals
  ...
  return (
    <div>
      {/* Temporarily disabled - awaiting quarry-specific hooks and modals */}
      {/* {confirmDialogs}
      {viewDialog}
