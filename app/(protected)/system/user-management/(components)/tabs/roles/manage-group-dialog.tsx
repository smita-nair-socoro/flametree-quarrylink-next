  ...
  return (
    <>
      ...
      <ActionDialog
        ...
        title="Remove from notification group"
        titleIcon={
          <UserRoundMinus className="h-4 w-4 shrink-0 text-red-500" />
        }
        titleClassName="text-[15px] mt-0"
        description={
          removeTarget && (
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-3">
                ...
                <p className="mt-1 text-[12px] text-amber-700">
                  This user will no longer receive {group.name.toLowerCase()}{' '}
                  emails. They will not be notified of this change.
                </p>
              </div>
              ...
              <div className="space-y-1.5 text-[12px]">
                ...
                <p>
                  <span className="font-semibold">Immediate effect:</span> User
                  is removed from the {group.name} Cognito group
                </p>
                <p>
                ...
                <p>
                  ...
                  Their permission role ({removeTarget.role}) and system access
                  remain exactly the same
                </p>
                <p>
                  <span className="font-semibold">Reversible:</span> You can add
                  them back to this group at any time
                </p>
              </div>
            </div>
          )
