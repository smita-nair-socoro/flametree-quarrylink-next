      ...
      <div className="border border-gray-200 rounded-lg p-3 flex items-center justify-between w-full">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className={`flex items-center gap-1.5 border rounded-lg px-3 py-1.5 text-sm hover:bg-gray-50 transition-colors ${selectedTruckType.length > 0 ? 'border-gray-300' : 'border-gray-200'}`}>
                  <Plus className="w-4 h-4 text-gray-500" />
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className={`flex items-center gap-1.5 border rounded-lg px-3 py-1.5 text-sm hover:bg-gray-50 transition-colors ${selectedHaulier.length > 0 ? 'border-gray-300' : 'border-gray-200'}`}>
                  <Plus className="w-4 h-4 text-gray-500" />
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button className={`flex items-center gap-1.5 border rounded-lg px-3 py-1.5 text-sm hover:bg-gray-50 transition-colors ${selectedTrucks.length > 0 ? 'border-gray-300' : 'border-gray-200'}`}>
                  <Plus className="w-4 h-4 text-gray-500" />
