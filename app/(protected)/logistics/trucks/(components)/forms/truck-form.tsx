...
export default function TruckForm({
  ...
  React.useEffect(() => {
    if (prevHaulierIdRef.current !== undefined && prevHaulierIdRef.current !== effectiveHaulierId) {
  ...
  const isGenericTruck = isEditing &&
        ...
        >
          ...
          {isGenericTruck && (
            <div className="flex items-start gap-2 bg-blue-50 border border-blue-200 text-blue-900 rounded-md px-4 py-3 text-sm">
              ...
              <span>This is a generic truck automatically generated by the system for the hauler.</span>
            </div>
          )}
