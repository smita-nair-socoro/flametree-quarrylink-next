...
import { getQuotationFormSchema } from '../quotation-form-schema';
...
describe('QuotationFormSchema delivery time window validation', () => {
  const schema = getQuotationFormSchema(false);
