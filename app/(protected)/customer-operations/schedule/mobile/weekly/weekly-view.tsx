...
import { MapPin, SlidersHorizontal, Truck } from 'lucide-react';
...
} from '../schedule-status-filters-drawer';
...
export function ScheduleMobileWeeklyView({
  ...
  const filtersActive = hasActiveScheduleStatusFilters(filter);
    ...
    <div className="flex min-h-0 flex-1 flex-col bg-[#F8FAFC]">
      <div className="shrink-0 border-b border-gray-200 bg-white px-4 py-3">
        <Button
          ...
          variant="outline"
          className={cn(
            'h-10 rounded-xl border-gray-200 bg-white font-semibold text-[#0F172A]',
            filtersActive && 'border-[#C4B5FD] bg-[#FAF5FF] text-[#7C3AED]',
          )}
