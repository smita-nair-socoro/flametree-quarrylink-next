...
import { formatDocketSignOffAt, getDocketSignOffCopy } from '../docket-sign-off';
...
describe('formatDocketSignOffAt', () => {
  test('includes date and time for collection', () => {
    expect(formatDocketSignOffAt('2026-09-09T09:43:00', true)).toBe(
      'Collected at 09 Sep 2026, 9:43 AM',
    );
  });

  test('includes date and time for delivery', () => {
    expect(formatDocketSignOffAt('2026-09-09T09:43:00', false)).toBe(
      'Delivered at 09 Sep 2026, 9:43 AM',
    );
  });
});
