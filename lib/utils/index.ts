...
export const BADGE_COLORS: Record<string, string> = {
  ...
  ROADBASE: 'bg-orange-100 text-orange-900 border-orange-900',
  'LANDSCAPE ROCK': 'bg-orange-100 text-orange-900 border-orange-900',
  'OVERSIZED ROCK': 'bg-gray-100 text-gray-900 border-gray-900',
  BALLAST: 'bg-orange-100 text-orange-900 border-orange-900',
  'STABILISED MATERIAL': 'bg-blue-100 text-blue-900 border-blue-900',
  'RECYCLED MATERIAL': 'bg-yellow-100 text-yellow-900 border-yellow-900',
