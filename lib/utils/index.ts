...
export const BADGE_COLORS: Record<string, string> = {
  ...
  'NOT SYNCED': 'bg-gray-100 text-gray-800 border-gray-800',
  NOT_SYNCED: 'bg-gray-100 text-gray-800 border-gray-800',
  SALES_ORDER_SYNCED: 'bg-yellow-100 text-yellow-900 border-yellow-900',
  'SALES ORDER SYNCED': 'bg-yellow-100 text-yellow-900 border-yellow-900',
  INTERNAL_TRANSFER: 'bg-slate-100 text-slate-800 border-slate-800',
  'INTERNAL TRANSFER': 'bg-slate-100 text-slate-800 border-slate-800',
