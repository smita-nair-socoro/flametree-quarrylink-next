...
export enum ADDITIONAL_CONTACT_METHOD_TYPE {
...
export const ADDITIONAL_CONTACT_METHOD_TYPE_LABELS: Record<
  ADDITIONAL_CONTACT_METHOD_TYPE,
  string
> = {
  [ADDITIONAL_CONTACT_METHOD_TYPE.BUSINESS_PHONE]: 'Business Phone',
  [ADDITIONAL_CONTACT_METHOD_TYPE.WORK_PHONE]: 'Work Phone',
  [ADDITIONAL_CONTACT_METHOD_TYPE.MOBILE_PHONE]: 'Mobile Phone',
  [ADDITIONAL_CONTACT_METHOD_TYPE.HOME_PHONE]: 'Home Phone',
  [ADDITIONAL_CONTACT_METHOD_TYPE.ASSISTANT_PHONE]: 'Assistant Phone',
  [ADDITIONAL_CONTACT_METHOD_TYPE.FAX]: 'Fax',
  [ADDITIONAL_CONTACT_METHOD_TYPE.EMAIL]: 'Email',
  [ADDITIONAL_CONTACT_METHOD_TYPE.OTHER]: 'Other',
};
