...
export function useProductActions(
  ...
  const getFakeDialogConfigs = (
    ...
    return {
      ...
      unavailable: {
        title: `Mark as unavailable`,
        description: `Mark this product as unavailable`,
        confirmText: 'Mark as unavailable',
        confirmVariant: 'default',
      },
      available: {
      ...
      cannotArchive: {
        ...
        description: `Cannot archive this product`,
        confirmText: 'Cannot archive',
        confirmVariant: 'default',
      },
      unarchive: {
        title: `Unarchive`,
  ...
  const dialogConfigs = getFakeDialogConfigs(
    productData,
