...
export function useClientUserActions(
  ...
  // Simulate different dependency scenarios based on user ID
  const getMockDependencies = (id: number | undefined) => {
    ...
    switch (id) {
      ...
      case 7: // No dependencies
        return { customerCount: 0, activeJobsCount: 0 };
      case 8: // Only customers
        return { customerCount: 4, activeJobsCount: 0 };
      case 9: // No dependencies (pending)
        return { customerCount: 0, activeJobsCount: 0 };
      case 10: // No dependencies (inactive)
        return { customerCount: 0, activeJobsCount: 0 };
      default:
        return { customerCount: 0, activeJobsCount: 0 };
    }
  ...
  const { customerCount, activeJobsCount } = getMockDependencies(userId);
  ...
  const actions = {
    ...
    deactivate: () => {
      ...
      console.log('Deactivate user:', userData);
    },
    viewEdit: () => {
      setViewOpen(true);
    },
    resetPassword: () => {
      ...
      console.log('Reset password for user:', userData);
    },
  };
  ...
  const handleDeleteConfirm = () => {
    ...
    if (hasDependencies) {
      ...
      // API call: DELETE /api/client-users/${userId} with reassignment data
      ...
      // API call: DELETE /api/client-users/${userId}
